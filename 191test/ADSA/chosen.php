        ...
        <td><table width="900" border="0" align="center">
          <tr>
             ...
             <?php 
				...
				echo "<h2><i>You are now in ";
				echo "<strong>".$row['orgname']."</strong>"."'s control panel.</i></h2>";
			  ?>
             <br>
...
<table width="399" border="0" align="center">
  <tr>
    <td width="105" align="right"><a href="viewstatus.php"><span class="middle_link"><img src="../images/zoom.png" width="64" height="64" /></span></a></td>
    <td width="20" align="right"><p><a href="viewstatus.php"></a></p></td>
    <td width="194" class="middle_link"><a href="viewstatus.php"><span class="middle_link">View Status</span></a></td>
  </tr>
  <tr>
    <td align="right"><a href="eval.php"><span class="middle_link"><img src="../images/documents.png" width="64" height="64" /></span></a></td>
    <td align="right"><a href="eval.php"></a></td>
    <td class="middle_link"><a href="eval.php"><span class="middle_link">Evaluate Requirements</span></a></td>
  </tr>
  <tr>
    <td align="right"><a href="setstatus.php"><span class="middle_link"><img src="../images/certificate.png" width="64" height="64" /></span></a></td>
    <td align="right"><a href="setstatus.php"></a></td>
    <td class="middle_link"><a href="setstatus.php">Set Recognition Status</a></td>
  </tr>
</table>
<br />
<table width="399" border="0" align="center">
  <tr class="middle_link">
    <td width="102" height="84" align="right"><strong><a href="index.php"><img src="../images/left.png" width="64" height="64" /></a></strong></td>
    <td width="10" align="right">&nbsp;</td>
    <td width="273"><p><strong><a href="index.php">Select a different Organzation<br />
    </a></strong></p></td>
  </tr>
</table>
<p>&nbsp;</p></td>
