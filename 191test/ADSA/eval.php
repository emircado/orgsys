                ...
                <table width="85%" border="0">
                  <tr>
                    <td align="left"><table width="399" border="0" align="center">
                      <tr>
                        <td width="116" align="right"><img src="../images/documents.png" width="64" height="64" /></td>
                        <td width="5" align="right">&nbsp;</td>
                        <td width="202">Evaluate Requirements</td>
                      </tr>
                    </table>
                      <br />
...
<p>&nbsp;</p>
                            <table width="33%" border="0" align="right" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td width="75%" align="right">View Document</td>
                                <td width="25%" align="right"><img src="../images/link.png" width="32" height="32" /></td>
                              </tr>
                              <tr>
                                <td align="right">Approve Document</td>
                                <td align="right"><img src="../images/checkmark.png" width="32" height="32" /></td>
                              </tr>
                              <tr>
                                <td align="right">Reject Document</td>
                                <td align="right"><img src="../images/close.png" width="32" height="32" /></td>
                              </tr>
                            </table>
                            <p><br />
                              <br />
								...
								$fetched_data = mysqli_fetch_array($result2);
							 	...
							 	echo "<tr>";
									...
									echo "<td valign='middle' align='right'>";									
										...
										echo "'>";
											echo "<img src='../images/link.png' width='32' height='32' >";
										echo "</a>";
										
										echo "<a href='update2.php?rid=";			
										echo $row['rid'];
										echo "&status=2";			
										echo "'>";
											echo "<img src='../images/checkmark.png' width='32' height='32' >";
										echo "</a>";
										...
										echo "&status=1";			
										echo "'>";
											echo "<img src='../images/close.png' width='32' height='32' >";
										echo "</a>";
																	
									echo "</td>";
									
									echo "<td valign='middle' align='right'>Currently:<br><strong>";
