    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="900" border="0" align="center">
          <tr>
              <td width="1034" align="center"><h2><strong>Welcome Student Organization Representative!</strong><br />
              </h2>
                <p><br />
                  <br />
                  To view, your Organization's status, please log-in below with your unique key.<br />
                  <br />
                </p>
                <form action="chosen.php" method="post">
                  ...
                  <input type="text" name="uk" />
                    <br />
                    <input type="image"  src="../images/zoom.png" border="0"/>
                  </p>
                </form>
</p></td>
              </tr>
