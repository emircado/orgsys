  ...
  <tr align="center">
	...
	<?php
		foreach ($organizations as $org) {
			...
			echo '<tr><td align="right"></td></tr><a href="'.site_url('organizations/upload_docs/'.$org->code).'">Upload documents for '.$org->code.'</a></td></tr></br>';
			echo '<tr><td align="right"></td></tr><a href="'.site_url('organizations/evaluate/'.$org->code).'">Evaluate documents for '.$org->code.'</a></td></tr>';
